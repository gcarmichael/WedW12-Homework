...
/***/ function(module, exports) {
	...
	Bank.prototype = {
	  ...
	  removeAccount: function removeAccount(holderName) {
	...
	var BankBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        AccountSelect,
	        { types: this.getAccountType(), changeAccountType: this.changeAccountType },
	        ' '
	      ),
	      React.createElement(
	        'button',
	        { onClick: this.payInterest },
	        'Pay Interest'
	      ),
	  ...
	  createRow: function createRow(account) {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { onClick: this.handleClick, key: account.owner, id: account.owner, value: account.owner },
	          'See Account Info'
	        )
	      )
	    );
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.type,
	        ' cash: £',
	        Number(filteredBank.totalCash()).toLocaleString(),
	        ' '
	      ),
	      React.createElement(
	        'table',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountDisplay = React.createClass({
	  ...
	  handleDetailChange: function handleDetailChange(event) {
	    ...
	    if (this.props.account) {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          null,
	          "Cash: £",
	          Number(this.props.account.amount).toLocaleString()
	        ),
	        React.createElement(
	          "p",
	          null,
	        ...
	        React.createElement(
	          "button",
	          { onClick: this.handleClick, value: this.props.account.owner },
	          "Remove Account"
	        )
	      );
	    } else {
